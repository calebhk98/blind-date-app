"""Zoosk adapter (scaffold -- NOT implemented).

Signup / login: https://www.zoosk.com/login
Backend: web
Notes: Full web dating platform. Email/phone and social auth available.
...
SIGNUP_URL = "https://www.zoosk.com/login"


class ZooskAdapter(WebBackendAdapter):
    def __init__(self, swiped_store: SwipedStore) -> None:
        super().__init__("zoosk", swiped_store)

    def _login_impl(self) -> None:
        raise NotImplementedError("Zoosk adapter not implemented yet")
