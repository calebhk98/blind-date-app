"""OkCupid adapter (scaffold -- NOT implemented).

Signup / login: https://www.okcupid.com/
Backend: web
Notes: Persistent session auth via Playwright. Full web UI available.
...
SIGNUP_URL = "https://www.okcupid.com/"


class OkCupidAdapter(WebBackendAdapter):
    def __init__(self, swiped_store: SwipedStore) -> None:
        super().__init__("okcupid", swiped_store)

    def _login_impl(self) -> None:
        raise NotImplementedError("OkCupid adapter not implemented yet")
