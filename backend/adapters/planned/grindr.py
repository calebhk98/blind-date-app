"""Grindr adapter (scaffold -- NOT implemented).

Signup / login: https://web.grindr.com/login
Backend: web
Notes: Full web version available. Largest dating app for LGBTQ+ men.
Requires location access and browser pop-ups.
...
SIGNUP_URL = "https://web.grindr.com/login"


class GrindrAdapter(WebBackendAdapter):
    def __init__(self, swiped_store: SwipedStore) -> None:
        super().__init__("grindr", swiped_store)

    def _login_impl(self) -> None:
        raise NotImplementedError("Grindr adapter not implemented yet")
