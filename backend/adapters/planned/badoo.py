"""Badoo adapter (scaffold -- NOT implemented).

Signup / login: https://badoo.com/signin
Backend: web
Notes: Full web platform. Phone/email/social auth. Mobile web at m.badoo.com.
...
SIGNUP_URL = "https://badoo.com/signin"


class BadooAdapter(WebBackendAdapter):
    def __init__(self, swiped_store: SwipedStore) -> None:
        super().__init__("badoo", swiped_store)

    def _login_impl(self) -> None:
        raise NotImplementedError("Badoo adapter not implemented yet")
