"""eharmony adapter (scaffold -- NOT implemented).

Signup / login: https://www.eharmony.com/login/
Backend: web
Notes: Established web dating platform. Compatibility matching algorithm.
...
SIGNUP_URL = "https://www.eharmony.com/login/"


class EharmonyAdapter(WebBackendAdapter):
    def __init__(self, swiped_store: SwipedStore) -> None:
        super().__init__("eharmony", swiped_store)

    def _login_impl(self) -> None:
        raise NotImplementedError("eharmony adapter not implemented yet")
